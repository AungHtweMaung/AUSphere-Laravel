<meta charset="UTF-8">
<link rel="stylesheet" type="text/css" href="{{ asset('500/500.css') }}">
<link rel="stylesheet" type="text/css" href="{{ asset('500/oxygen.fonts.css') }}">
<div class="container">
        <div class="error">
            <h1>500</h1>
            <h2>error</h2>
    ...
    <footer>
        <p class="copyright">©2020 Grupo Multimedios Argentina</p>
    </footer>
    </div>
    <style>
        footer {
	...
	<script type="text/javascript" src="{{ asset('500/500.js') }}"></script>
