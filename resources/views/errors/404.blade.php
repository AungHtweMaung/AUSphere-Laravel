<meta charset="UTF-8">
<link rel="stylesheet" type="text/css" href="{{ asset('404/404.css') }}">
<link rel="stylesheet" type="text/css" href="{{ asset('404/oxygen.fonts.css') }}">
<div class="container">
        <div class="error">
            <h1>404</h1>
            <h2>error</h2>
                ...
                <div class="perspec" style="--spreaddist: 0px; --scaledist: 1; --vertdist: 0px;">
                    <div class="card">
                        <div class="writing">
                            ...
                            <div class="code">
                                <div class="centered">
                                    <img src="{{ asset('404/sign_question.png') }}">
                                </div>
                            </div>
                        </div>
                    </div>
	...
	<script type="text/javascript" src="{{ asset('404/404.js') }}"></script>
