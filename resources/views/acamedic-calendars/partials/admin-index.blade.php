                        ...
                        <tbody>
                            ...
                            @foreach ($academicCalendars as $calendar)
                                <tr class="">
                                    ...
                                    <td>
                                        <a href="{{ asset('storage/' . $calendar->calendar_file) }}" target="_blank"
                                            class="fs-6">
                                            <span class="text-primary"><i class="fa-solid fa-file"></i> View File</span>
                                        </a>
                                    </td>
                                    <td>
                                        <a href="{{ route('academic-calendars.show', $calendar->id) }}"
                                            class="btn btn-warning btn-sm text-white">
                                            <i class="fa-regular fa-eye"></i>
                                        </a>
                                        <a href="{{ route('academic-calendars.edit', $calendar->id) }}"
                                            class="btn btn-primary btn-sm text-white">
                                            <i class="fa-regular fa-edit"></i>
                                        </a>
                                        <button data-href="{{ route('academic-calendars.destroy', $calendar->id) }}"
                                            class="btn btn-danger btn-sm text-white delete-data">
